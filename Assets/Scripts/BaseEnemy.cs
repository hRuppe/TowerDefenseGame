...
public abstract class BaseEnemy : MonoBehaviour, IDamage
{
    ...
    protected float speedToAnimationDefault = 4.75f; // This value is the speed value that looks best with a "1" value on the enemy run animation (shouldn't need adjustment, which is why it's hardcoded)
